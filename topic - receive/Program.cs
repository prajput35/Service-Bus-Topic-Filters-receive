...
namespace topic___receive
{
    ...
    class Program
    {
        private static string _bus_connectionstring = "Endpoint=sb://servicebusns204.servicebus.windows.net/;SharedAccessKeyName=test;SharedAccessKey=L6Ev2TqRc5aaBG/kNR+J5FoqLsTftIxyFZZ2hnQOnMM=;EntityPath=apptopic";
        
        private static ISubscriptionClient _client;
        private static string _subscription_name = "SubscriptionB";
